...
INSERT into "Representante" (CEDULA, FK_ID_REGION, FK_ID_REP_PADRE, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, CORREO_ELECTRONICO, GENERO, FECHA_NACIMIENTO, FECHA_CONTRATO, TEL_CONTACTO, GRADO, CONTRASENA, ESTADO, CIUDAD, DIRECCION)
                    VALUES (1234567890, 3, 1193220649, 'Mateo', NULL, 'Yate', 'Gonzalez', 'prueba2@gmail.com', 'M', '01-02-1999', '22-08-2021', 3006485672, 'beginner', 'prueba1234', 'A', 'Bogotá', 'Calle 2');

INSERT into "Representante" (CEDULA, FK_ID_REGION, FK_ID_REP_PADRE, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, CORREO_ELECTRONICO, GENERO, FECHA_NACIMIENTO, FECHA_CONTRATO, TEL_CONTACTO, GRADO, CONTRASENA, ESTADO, CIUDAD, DIRECCION)
                    VALUES (2345678901, 3, 1193220649, 'Kevin', 'Andres', 'Borda', 'Penagos', 'prueba3@gmail.com', 'M', '03-04-2000', '22-08-2021', 3006485673, 'beginner', 'prueba12345', 'A', 'Bogotá', 'Calle 3');

INSERT into "Representante" (CEDULA, FK_ID_REGION, FK_ID_REP_PADRE, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, CORREO_ELECTRONICO, GENERO, FECHA_NACIMIENTO, FECHA_CONTRATO, TEL_CONTACTO, GRADO, CONTRASENA, ESTADO, CIUDAD, DIRECCION)
                    VALUES (3456789012, 2, NULL, 'Brayan', 'Alexander', 'Paredes', 'Sanchez', 'prueba4@gmail.com', 'M', '20-09-1999', '22-08-2021', 3006485674, 'senior', 'prueba123456', 'A', 'Leticia', 'Calle 4');

INSERT into "Representante" (CEDULA, FK_ID_REGION, FK_ID_REP_PADRE, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, CORREO_ELECTRONICO, GENERO, FECHA_NACIMIENTO, FECHA_CONTRATO, TEL_CONTACTO, GRADO, CONTRASENA, ESTADO, CIUDAD, DIRECCION)
                    VALUES (4567890123, 4, NULL, 'Diego', 'Alejandro', 'Gonzalez', NULL, 'prueba5@gmail.com', 'M', '20-09-1999', '22-08-2021', 3006485675, 'junior', 'prueba1234567', 'A', 'San Andrés', 'Calle 5');
