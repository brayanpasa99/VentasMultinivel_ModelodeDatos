...
INSERT INTO "Grado" (NOMBRE_GRADO, PORCENTAJE_COMISION, CALIFICACION_MINIMA, VENTA_MINIMA) VALUES ('junior', 4, 3.5, 5000000);
INSERT INTO "Grado" (NOMBRE_GRADO, PORCENTAJE_COMISION, CALIFICACION_MINIMA, VENTA_MINIMA) VALUES ('senior', 6, 4, 10000000);
INSERT INTO "Grado" (NOMBRE_GRADO, PORCENTAJE_COMISION, CALIFICACION_MINIMA, VENTA_MINIMA) VALUES ('master', 8, 4.5, 50000000);
...
INSERT INTO "Inventario" (FK_ID_REGION, FK_ID_PRODUCTO, PRECIO, CANTIDAD) VALUES (3, 5, 4000, 50);
...
INSERT INTO "Inventario" (FK_ID_REGION, FK_ID_PRODUCTO, PRECIO, CANTIDAD) VALUES (3, 12, 1200, 38);
...
INSERT INTO "Calificacion" (FK_ID_PEDIDO, NOTA, OBSERVACION) VALUES (1, 5, 'Buen Servicio');
INSERT INTO "Calificacion" (FK_ID_PEDIDO, NOTA, OBSERVACION) VALUES (2, 3, 'Faltantes en el pedido');

-- Insertar RepresentantePeriodo
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (1193220649, 1, 'master', 8, 51000000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (1193220649, 2, 'master', 8, 52000000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (1193220649, 3, 'master', 8, 53000000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (1193220649, 4, 'master', 8, 100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (1235478943, 1, 'beginner', 2, 100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (1235478943, 2, 'beginner', 2, 100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (1235478943, 3, 'beginner', 2, 100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (1235478943, 4, 'beginner', 2, 100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (6487548324, 1, 'junior', 4, 5100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (6487548324, 2, 'junior', 4, 5100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (6487548324, 3, 'junior', 4, 5100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (6487548324, 4, 'junior', 4, 5100000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (3579518521, 1, 'senior', 2, 11000000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (3579518521, 2, 'senior', 2, 11000000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (3579518521, 3, 'senior', 2, 11000000);
INSERT INTO "RepresentantePeriodo" (FK_CEDULA_REPRESENTANTE, FK_ID_PERIODO, GRADO, PORCENTAJE, VALOR_RECAUDADO) VALUES (3579518521, 4, 'senior', 2, 11000000);